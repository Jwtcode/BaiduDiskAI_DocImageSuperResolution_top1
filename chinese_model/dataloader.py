...
class DL(Dataset):
    def __init__(self, rgb_dir, img_options=None,scale=4,mode='train'):
        ...
        self.scale=scale
        self.lr_path=os.path.join(rgb_dir,'chinese_n_x')
        self.hr_x2_path=os.path.join(rgb_dir,'chinese_n_x2')
        self.hr_x4_path=os.path.join(rgb_dir,'chinese_n_x4')
    ...
    def __getitem__(self, index):
        ...
        if self.mode == 'train':
            ...
            ############################################
#             w4,h4,c4=x2_tar_img.shape
#             if(w4!=256 or h4!=256):
#                 print(x2_tar_img.shape)
#                 print(pos)
#                 print (name)
